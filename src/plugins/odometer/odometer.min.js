(function () {
  ...
  ((t = /^\(?([^)]*)\)?(?:(.)(d+))?$/),
    ...
    (i =
      null != h.transition ||
      null != h.webkitTransition ||
      null != h.mozTransition ||
      null != h.oTransition),
    (d =
    ...
    (p = function (t, e) {
      ...
      if (null != document.createEvent)
        return (
          (n = document.createEvent("HTMLEvents")).initEvent(e, !0, !0),
          t.dispatchEvent(n)
        );
    }),
    (a = function () {
      ...
      return null !=
        (t =
          null != (e = window.performance) && "function" == typeof e.now
            ? e.now()
            : void 0)
        ? t
        : +new Date();
    ...
    (n = (function () {
      function n(t) {
        ...
        for (e in ((this.el.odometer = this), (u = n.options)))
          ((o = u[e]), null == this.options[e] && (this.options[e] = o));
        (null == (r = this.options).duration && (r.duration = 2e3),
          (this.MAX_VALUES =
            (this.options.duration / 33.333333333333336 / 2) | 0),
          this.resetFormat(),
          (this.value = this.cleanValue(
            null != (d = this.options.value) ? d : "",
          )),
          this.renderInside(),
          this.render());
        try {
          for (
            s = 0, a = (l = ["innerHTML", "innerText", "textContent"]).length;
            s < a;
            s++
          )
            ((i = l[s]),
                ...
                (function (t) {
                  Object.defineProperty(h.el, t, {
                    get: function () {
                      ...
                      return "innerHTML" === t
                        ? h.inside.outerHTML
                        : null != (e = h.inside.innerText)
                          ? e
                          : h.inside.textContent;
                    },
                    set: function (t) {
                      return h.update(t);
                    },
      ...
      return (
        ...
        (n.prototype.startWatchingMutations = function () {
          if (this.watchMutations)
            return this.observer.observe(this.el, { childList: !0 });
        }),
        ...
        (n.prototype.resetFormat = function () {
          var e, n, i, o, r, s, a, u;
          if (
            ((e = null != (a = this.options.format) ? a : "(,ddd).dd") ||
              (e = "d"),
            !(i = t.exec(e)))
          )
          ...
          return (
            (s = (u = i.slice(1, 4))[0]),
            (r = u[1]),
            (o = (null != (n = u[2]) ? n.length : void 0) || 0),
            (this.format = { repeating: s, radix: r, precision: o })
          );
        }),
        (n.prototype.render = function (t) {
          ...
          for (
            ...
            (n = e[a]).length &&
              ((o = /^odometer-theme-(.+)$/.exec(n))
                ? (s = o[1])
                : /^odometer(-|$)/.test(n) || r.push(n));
          return (
            r.push("odometer"),
        ...
        (n.prototype.formatDigits = function (t) {
          ...
          if (((this.digits = []), this.options.formatFunction))
            for (
              o = 0,
                a = (d = this.options.formatFunction(t).split("").reverse())
                  .length;
              o < a;
              o++
            )
              (n = d[o]).match(/0-9/)
                ? (((e = this.renderDigit()).querySelector(
                    ".odometer-value",
                  ).innerHTML = n),
                  this.digits.push(e),
                  this.insertDigit(e))
            ...
            for (
              i = !this.format.precision || !s(t) || !1,
                r = 0,
                u = (l = t.toString().split("").reverse()).length;
              r < u;
              r++
            )
              ("." === (e = l[r]) && (i = !0), this.addDigit(e, i));
        }),
        (n.prototype.update = function (t) {
          ...
          if ((e = (t = this.cleanValue(t)) - this.value))
            return (
              ...
              o(
                this.el,
                e > 0 ? "odometer-animating-up" : "odometer-animating-down",
              ),
              this.stopWatchingMutations(),
              this.animate(t),
              this.startWatchingMutations(),
        ...
        (n.prototype.addDigit = function (t, e) {
          ...
          return (
            ((i = this.renderDigit()).querySelector(
              ".odometer-value",
            ).innerHTML = t),
            this.digits.push(i),
            this.insertDigit(i)
        ...
        (n.prototype.animate = function (t) {
          return i && "count" !== this.options.animation
            ? this.animateSlide(t)
            : this.animateCount(t);
        }),
            ...
            return (
              ...
              (r = function () {
                ...
                return a() - o > s.options.duration
                  ? ((s.value = t), s.render(), void p(s.el, "odometerdone"))
                  : ((u = a() - i) > 50 &&
                      ((i = a()),
                      (l = u / s.options.duration),
                      (e += n * l),
                      s.render(Math.round(e))),
                    null != d ? d(r) : setTimeout(r, 50));
              })()
            );
        }),
        (n.prototype.getDigitCount = function () {
          ...
          for (
            t = o = 0,
              r = (i = 1 <= arguments.length ? v.call(arguments, 0) : [])
                .length;
            o < r;
            t = ++o
          )
            ((n = i[t]), (i[t] = Math.abs(n)));
          return (
        ...
        (n.prototype.getFractionalDigitCount = function () {
          ...
          for (
            e = /^\-?\d*\.(\d*?)0*$/,
              t = r = 0,
              s = (o = 1 <= arguments.length ? v.call(arguments, 0) : [])
                .length;
            r < s;
            t = ++r
          )
        ...
        (n.prototype.animateSlide = function (t) {
          ...
          if (
            ((M = this.value),
            (d = this.getFractionalDigitCount(M, t)) &&
              ((t *= Math.pow(10, d)), (M *= Math.pow(10, d))),
            (i = t - M))
          ) {
            for (
              this.bindTransitionEnd(),
                r = this.getDigitCount(M, t),
                s = [],
                e = 0,
                p = b = 0;
              0 <= r ? b < r : b > r;
              ...
              if (
                ((w = c(M / Math.pow(10, r - p - 1))),
                (a = (u = c(t / Math.pow(10, r - p - 1))) - w),
                Math.abs(a) > this.MAX_VALUES)
              ) {
                for (
                  h = [],
                    m = a / (this.MAX_VALUES + this.MAX_VALUES * e * 0.5),
                    n = w;
                  (a > 0 && n < u) || (a < 0 && n > u);
                )
                  (h.push(Math.round(n)), (n += m));
                (h[h.length - 1] !== u && h.push(u), e++);
              } else
                h = function () {
                  A = [];
                  for (var t = w; w <= u ? t <= u : t >= u; w <= u ? t++ : t--)
                    A.push(t);
                  return A;
                }.apply(this);
              for (p = T = 0, x = h.length; T < x; p = ++T)
                ((l = h[p]), (h[p] = Math.abs(l % 10)));
              s.push(h);
            }
            for (
              this.resetDigits(), p = E = 0, S = (F = s.reverse()).length;
              E < S;
              p = ++E
            )
              for (
                h = F[p],
                  ...
                  null == (y = this.ribbons)[p] &&
                    (y[p] = this.digits[p].querySelector(
                ...
                ((l = h[f]),
                  ...
                  f === h.length - 1 && o(v, "odometer-last-value"),
                  0 === f && o(v, "odometer-first-value"));
            return (
              w < 0 && this.addDigit("-"),
              null != (g = this.inside.querySelector(".odometer-radix-mark")) &&
    ...
    (n.options = null != (f = window.odometerOptions) ? f : {}),
    setTimeout(function () {
      var t, e, i, o, r;
      if (window.odometerOptions) {
        for (t in ((r = []), (o = window.odometerOptions)))
          ((e = o[t]),
            r.push(
              null != (i = n.options)[t] ? (i = n.options)[t] : (i[t] = e),
            ));
        return r;
      }
    }, 0),
        ...
        (document.onreadystatechange = function () {
          return (
            "complete" === document.readyState &&
              !1 !== n.options.auto &&
              n.init(),
            null != m ? m.apply(this, arguments) : void 0
          );
        }))
